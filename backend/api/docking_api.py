...
class DockingPipeline:
    ...
    def run_pipeline(self, job_id: str, protein_input: str, ligand_input: str, cleaning_policy: dict, retention: str):
        try:
          ...
          self.update_progress(job_id, 40, "Analyzing protein")
          analyzer = ProteinPreprocessor(raw_protein_path)
          analysis = analyzer.summarize_pdb(analyzer.pdb_path)
          analysis_msg = f"Found: {analysis['waters']} waters, {analysis['ions']} ions, {analysis['solvents']} solvents, {analysis['cofactors']} cofactors"

          self.update_progress(job_id, 45, "Preparing protein")
          ...
          self.update_progress(job_id, 55, "Identifying binding sites")
          ...
          self.update_progress(job_id, 65, "Docking")
          ...
          self.update_progress(job_id, 85, "Parsing results")
          ...
          self.update_progress(job_id, 100, "Completed")
          if self.status_callback:
